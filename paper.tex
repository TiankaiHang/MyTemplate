...
\setcounter{page}{1}
\pagenumbering{Roman}
\addcontentsline{toc}{chapter}{摘\texorpdfstring{\qquad} 要}
...
\newpage
\tableofcontents
\addcontentsline{toc}{chapter}{目\texorpdfstring{\qquad} 录}
...
\vspace{-2em}
\input{Thanks.tex}
\addcontentsline{toc}{chapter}{致\texorpdfstring{\qquad} 谢}
